...
const Home: React.FC = () => {
	...
	return <Nav>
		...
		<View bg={3} outlined pad={2} rounded>
			<Text>Kaboom v3000.0 beta released! Checkout <Link href="/blog/3000">this article</Link> for more info. For v2000 doc go <a href="http://2000.kaboomjs.com/">here</a>.</Text>
		</View>
