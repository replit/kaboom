...
export function mapc(v, l1, h1, l2, h2) {
...
export function wave(lo, hi, t, f = Math.sin) {
    ...
    gen(...args) {
        if (args.length === 0) {
            ...
            if (typeof args[0] === "number" && typeof args[1] === "number") {
                ...
                return rgb(this.gen(args[0].r, args[1].r), this.gen(args[0].g, args[1].g), this.gen(args[0].b, args[1].b));
            }
        }
    }
}
...
// TODO: better name
export function testRectRect2(r1, r2) {
    return r1.p2.x >= r2.p1.x
        && r1.p1.x <= r2.p2.x
        && r1.p2.y >= r2.p1.y
        && r1.p1.y <= r2.p2.y;
}
export function testRectRect(r1, r2) {
    return r1.p2.x > r2.p1.x
        && r1.p1.x < r2.p2.x
        && r1.p2.y > r2.p1.y
        && r1.p1.y < r2.p2.y;
...
// TODO: better name
export function testLineLineT(l1, l2) {
...
export function testRectPoint2(r, pt) {
    return pt.x >= r.p1.x && pt.x <= r.p2.x && pt.y >= r.p1.y && pt.y <= r.p2.y;
}
export function testRectPoint(r, pt) {
    return pt.x > r.p1.x && pt.x < r.p2.x && pt.y > r.p1.y && pt.y < r.p2.y;
}
export function testRectCircle(r, c) {
...
export function testRectPolygon(r, p) {
...
// TODO
export function testLinePoint(l, pt) {
    return false;
}
// TODO
export function testLineCircle(l, c) {
    return false;
}
export function testLinePolygon(l, p) {
...
export function testCirclePoint(c, p) {
...
// TODO
export function testCirclePolygon(c, p) {
    return false;
}
export function testPolygonPolygon(p1, p2) {
...
export function testPolygonPoint(p, pt) {
    let c = false;
...
export function testPointPoint(p1, p2) {
    return p1.eq(p2);
}
export function testAreaRect(a, r) {
    switch (a.shape) {
    ...
    throw new Error(`Unknown area shape: ${a.shape}`);
}
export function testAreaLine(a, l) {
    switch (a.shape) {
...
export function testAreaCircle(a, c) {
    switch (a.shape) {
...
export function testAreaPolygon(a, p) {
    switch (a.shape) {
...
export function testAreaPoint(a, p) {
    switch (a.shape) {
...
export function testAreaArea(a1, a2) {
    switch (a2.shape) {
    ...
    throw new Error(`Unknown area shape: ${a2.shape}`);
}
