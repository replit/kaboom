...
export function testPointShape(point: Point, shape: any): boolean {
...
export function testLineShape(line: Line, shape: any): boolean {
    if (shape instanceof Vec2) {
...
export function testCircleShape(circle: Circle, shape: any): boolean {
    if (shape instanceof Vec2) {
...
export function testRectShape(rect: Rect, shape: any): boolean {
    if (shape instanceof Vec2) {
...
export function testPolygonShape(polygon: Polygon, shape: any): boolean {
    if (shape instanceof Vec2) {
...
export function testShapeShape(shape1: any, shape2: any): boolean {
